...
class MainActivity : AppCompatActivity() {
    ...
    fun quote(view: View){
        val quotes = arrayOf(
            ...
            "Respire fundo e fique atento às surpresas que a vida preparou!",
            "Nem todos os dias são bons, mas há algo bom em cada dia.",
            "Respeite sua mente e trate seu corpo com carinho",
            "Um passo de cada vez. Até meio passo serve. Não há morivo para ter pressa",
